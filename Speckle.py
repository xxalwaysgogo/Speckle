...
if __name__ == '__main__':
    '''
    generate_and_save(height, width, dpi, speckle_diameter, path)
    height: the height of output image in mm
    width: the width of output image in mm
    dpi: DPI setting for printing
    speckle_diameter: diameter of speckle
    path: output file name.
    '''
    slika = generate_and_save(200, 248, 300, 3, 'E:\Vision camera\DIC\Sample\Rigid\C4D\Speckle\example.jpg', size_randomness=0.5, position_randomness=0.9, speckle_blur=1, grid_step=1.2)
